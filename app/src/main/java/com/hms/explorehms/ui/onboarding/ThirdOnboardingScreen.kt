...
fun ThirdOnboardingScreen(){
    ...
    Column(
        ...
        Image(painter = painterResource(id = R.drawable.bg_onboarding3),
            contentDescription = null,
            modifier = Modifier.padding(16.dp))

        Text(
            text = stringResource(R.string.categories_headline_onboarding3),
            style = Headline5,
            modifier = Modifier.padding(16.dp)
        )
        Text(
            text = stringResource(id = R.string.category_info_onboarding3),
            style = Body1,
            modifier = Modifier.padding(16.dp)
        )
    }
